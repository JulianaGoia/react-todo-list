...
export function TaskCard({text, onDeleteTask}) {
    ...
    if(text.length > 0) {
        return (
            <div className={styles.taskCard}>
                ...
                <button title='Deletar tarefa' className={styles.deleteButton} onClick={handleDeleteTask}>
    ...
    // if(text.length === 0) {
    //     return (
    //         <div className={styles.messageNone}>
